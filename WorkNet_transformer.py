...
class WorkNet(nn.Module):
    """Causal Transformer Worker restored from the requested experiment snapshot."""
    ...
    def forward(self, x: torch.Tensor, v, hx=None):
        ...
        # Keep raw input tokens as memory. Reusing encoded outputs would encode
        # old Transformer outputs again and repeatedly add positional embeddings.
        return act, None, seq
